...
_Generated 2026-04-24T16:21:10+00:00 · N=15 prompts · repo has 51 source files, 448 indexed symbols_
...
Context-OS repo itself (51 source files, 448 symbols,
...
|---|---:|---:|---:|---:|---:|
| **auto_context** | **0.322** | 0.933 | **0.789** | 0.667 | 1.000 |
| bm25-symbols | 0.222 | 0.667 | 0.581 | 0.467 | 1.000 |
| bm25-path | 0.256 | 0.600 | 0.525 | 0.467 | 0.867 |
| grep-count | 0.111 | 0.333 | 0.281 | 0.133 | 1.000 |
| naive-filename | 0.289 | 0.533 | 0.480 | 0.400 | 0.867 |
| random | 0.000 | 0.000 | 0.042 | 0.000 | 1.000 |
...
|---|---:|---:|---:|---:|---:|---:|
| bm25-symbols | 0.789 | 0.581 | **+0.208** | 0.322 | 0.222 | **+0.100** |
| bm25-path | 0.789 | 0.525 | **+0.264** | 0.322 | 0.256 | **+0.067** |
| grep-count | 0.789 | 0.281 | **+0.507** | 0.322 | 0.111 | **+0.211** |
| naive-filename | 0.789 | 0.480 | **+0.309** | 0.322 | 0.289 | **+0.033** |
| random | 0.789 | 0.042 | **+0.747** | 0.322 | 0.000 | **+0.322** |
...
| loop-guard | `hooks/python/loop_guard.py` | `hooks/python/loop_guard.py`, `hooks/python/file_size_guard.py`, `hooks/python/dedup_guard.py` | 0.33 | 1.00 |
...
| robustness-tests | `python/evals/runners/robustness_test.py` | `hooks/python/auto_context.py`, `python/evals/runners/robustness_test.py`, `python/evals/runners/autocontext_ablation.py` | 0.33 | 0.50 |
